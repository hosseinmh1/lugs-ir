...
برای اینکه مشخص شود سمت راست و چپ هر کدام از خطوط (سمت خطوط با توجه به جهت رسم آن بوسیله فلش روی خط قابل تشخیص است) کدام محله قرار دارد از تگ right:neibourhood=نام محله سمت راست خط و تگ left:neibourhood=نام محله سمت چپ استفاده میکنیم.

 برای مثال عکس زیر را درنظر بگیرید.جهت رسم خطوط ساعتگرد میباشد درنتیجه سمت راست همه خطوط محله 1 میباشد ولی اگر برای مثال خط بالای محله یک بالعکس رسم میشد در این صورت محله 3 در سمت راست بود.

![تصویر ۳](/assets/img/osmp0i22.png)
