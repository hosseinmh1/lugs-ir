...
<h1>شروع به کار در OpenStreetMap.org</h1>
<blockquote>
<p>این راهنما را میتوان به صورت <a href="/hotosm/learnosm/blob/gh-pages/files/beginner_start-osm_fa.odt">beginner_start-osm_fa.odt</a> یا <a href="/hotosm/learnosm/blob/gh-pages/files/beginner_start-osm_fa.pdf">beginner_start-osm_fa.pdf</a> دانلود کرد<br>
...
می‌بینید:</p>
<pre><code>![OpenStreetMap website with some main functions listed](/assets/img/start-osm_website.png)
</code></pre>
...
<pre><code>![Mouse navigation](/assets/img/mouse-navigation.png)
</code></pre>
...
<pre><code>![Search](/assets/img/search.png)
</code></pre>
...
<pre><code>![Layers button](/assets/img/layers.png)
</code></pre>
...
قرار دارند.</p>
<pre><code>![Transport map](/assets/img/transport-map.png)
</code></pre>
...
<pre><code>![Registering an OpenStreetMap account](/assets/img/registering-account.png)
</code></pre>
...
<pre><code>![Confirming your OpenStreetMap account](/assets/img/confirming-account.png)
</code></pre>
...
<pre><code>![Click edit](/assets/img/click-edit.png)
</code></pre>
<p>ویرایشگر آنلاین که iD نامیده می‌شود باز خواهد شد. چیزی شبیه این دیده می‌شود.</p>
<pre><code>![iD editor](/assets/img/id-editor.png)
</code></pre>
...
<pre><code>![Point button](/assets/img/point-button.png)   
</code></pre>
...
<pre><code>![Save button](/assets/img/save-button.png)  
</code></pre>
